...
class DummyCategory {
  ...
  static List<ProductModel> products = [
    ProductModel(
      name: 'Broccoli',
      weight: '600 gm',
      cover: 'https://i.imgur.com/3o6ons9.png',
    ...
    ProductModel(
      name: 'Carrot',
      weight: '1 Kg',
      cover: 'https://i.imgur.com/upadTSW.jpeg',
    ...
    ProductModel(
      name: 'Fresh Milk',
      weight: '1 Kg',
      cover: 'https://i.imgur.com/F53fZuS.jpeg',
      images: ['https://i.imgur.com/F53fZuS.jpeg'],
      price: 15,
      mainPrice: 18,
    ),
    ProductModel(
    ...
    ProductModel(
      name: 'Tray of eggs',
      weight: '1 Kg',
      cover: 'https://i.imgur.com/LbgzhdC.jpeg',
      images: ['https://i.imgur.com/LbgzhdC.jpeg'],
      price: 15,
      mainPrice: 18,
    ),
    ProductModel(
      name: 'Beef',
      weight: '1 Kg',
      cover: 'https://i.imgur.com/X3pgX83.jpeg',
      images: ['https://i.imgur.com/X3pgX83.jpeg'],
      price: 15,
      mainPrice: 18,
    ),
  ];
